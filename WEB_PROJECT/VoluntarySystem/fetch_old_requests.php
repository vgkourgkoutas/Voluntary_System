...
// SQL ερώτημα για την επιλογή όλων των εγγραφών από τον πίνακα 'old_requests'
// που αντιστοιχούν στον τρέχοντα πολίτη με βάση το citizen_id
$sql = "SELECT * FROM old_requests WHERE oldres_citizen_id = $citizen_id";
...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        $old_requests[] = $row; // Προσθήκη των εγγραφών στον πίνακα $old_requests
    }
}
