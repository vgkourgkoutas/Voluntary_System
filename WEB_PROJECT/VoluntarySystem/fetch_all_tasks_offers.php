...
if ($conn->connect_error) {
    die("Connection failed: " . $conn->connect_error); // Αν υπάρχει σφάλμα σύνδεσης, η εκτέλεση σταματά και εμφανίζεται μήνυμα σφάλματος
}
// Ερώτημα SQL για επιλογή όλων των εγγραφών από τον πίνακα current_tasks όπου το task_type είναι offer και αποθήκευση στο result
$sql = "SELECT * FROM current_tasks WHERE task_type = 'offer'";
